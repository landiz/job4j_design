...
class CSVReaderTest {
    ...
    @Test
    void whenFilterRowWithEmptyOneValue(@TempDir Path folder) throws Exception {
        String data = String.join(
                System.lineSeparator(),
                "name;age;last_name;education",
                "Tom;;Smith;Bachelor",
    ...
    @Test
    void whenFilterRowWithEmptyValues(@TempDir Path folder) throws Exception {
        String data = String.join(
                System.lineSeparator(),
                "name;age;last_name;education",
                "Tom;;Smith;Bachelor",
        ...
        String expected = String.join(
                ...
                "education;age;last_name",
                "Bachelor;;Smith",
                "Undergraduate;;Johnson",
                "Secondary special;;Brown"
        ).concat(System.lineSeparator());
        CSVReader.handle(argsName);
        assertThat(Files.readString(target.toPath())).isEqualTo(expected);
    }
    ...
    @Test
    void whenSourceFileEmpty(@TempDir Path folder) throws Exception {
        String data = "";
        File file = folder.resolve("source.csv").toFile();
        File target = folder.resolve("target.csv").toFile();
        ArgsName argsName = ArgsName.of(new String[]{
